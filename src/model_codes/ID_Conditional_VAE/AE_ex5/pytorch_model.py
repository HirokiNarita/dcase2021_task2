...
class Conditional_VAE(nn.Module):
    def __init__(self, in_features, mid_size, latent_size, num_classes):
        ...
        self.center_loss = CenterLoss(num_classes=num_classes, feat_dim=mid_size, use_gpu=True)
