...
class Transformer_Decoder(nn.Module):
    ...
    def __init__(self, embed_dim, seq_len):
        ...
        self.decoder_block1 = Decoder_Block(embed_dim, num_heads=1, dropout_ratio=0.1)
        self.decoder_block2 = Decoder_Block(embed_dim, num_heads=1, dropout_ratio=0.1)
        self.decoder_block3 = Decoder_Block(embed_dim, num_heads=1, dropout_ratio=0.1)
        self.decoder_block4 = Decoder_Block(embed_dim, num_heads=1, dropout_ratio=0.1)
        self.decoder_block5 = Decoder_Block(embed_dim, num_heads=1, dropout_ratio=0.1)
        self.decoder_block6 = Decoder_Block(embed_dim, num_heads=1, dropout_ratio=0.1)
    ...
    def forward(self, inputs):
        ...
        outputs, _ = self.decoder_block1(inputs, mask)
        outputs, _ = self.decoder_block2(outputs, mask)
        outputs, attn_weights = self.decoder_block3(outputs, mask)
        outputs, attn_weights = self.decoder_block4(outputs, mask)
        outputs, attn_weights = self.decoder_block5(outputs, mask)
        outputs, attn_weights = self.decoder_block6(outputs, mask)
    ...
    def get_loss(self, inputs, labels=None, imshow=False):
        ...
        #print(gt_inputs)
        inputs = inputs[:inputs.shape[0]-1, :, :] # [63, batch, 128] 0~63
        #print('inputs')
        #print(inputs)
        #print(inputs.shape)
