...
def extract_net(net, dataloaders_dict):
    ...
    #net.conv_block1.conv1.register_forward_hook(hook)
    net.conv_block1.conv2.register_forward_hook(hook)
    #net.conv_block2.conv1.register_forward_hook(hook)
    net.conv_block2.conv2.register_forward_hook(hook)
    #net.conv_block3.conv1.register_forward_hook(hook)
    net.conv_block3.conv2.register_forward_hook(hook)
    #net.conv_block4.conv1.register_forward_hook(hook)
    net.conv_block4.conv2.register_forward_hook(hook)
    #net.conv_block5.conv1.register_forward_hook(hook)
    net.conv_block5.conv2.register_forward_hook(hook)
    #net.conv_block6.conv1.register_forward_hook(hook)
    #net.conv_block6.conv2.register_forward_hook(hook)
